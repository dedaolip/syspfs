                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{!! route('project.update', ['id' => $project->id]) !!}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="<?php echo $project->name;?>" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="brand" type="text" class="form-control" name="brand" value="<?php echo $project->brand;?>" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="model" type="text" class="form-control" name="model" value="<?php echo $project->model;?>" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="patrimony" type="text" class="form-control" name="patrimony" value="<?php echo $project->patrimony;?>" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="dtaacquisition" type="date" class="form-control" name="dtaacquisition" value="<?php echo $project->dtaacquisition;?>" required="required">
                            </div>
                        </div>
